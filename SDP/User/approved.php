...
<body style="background-color: black;">
    ...
    <div style="width: fit-content; margin: auto; display: flex; flex-direction: column; align-items: center;">
        <h1 style="color: lightgreen;">Your Request has been approved by admin!</h1>
        <h2 style="color: white;">Our car maintenance department are starting to fix your car</h2>
        <h1 style="color: orange;">Go to Car Status to track your car maintenance process</h1><br>
        <input type="button" value="Lets Go" style="padding: 10px 20px 10px 20px;">
    </div><br><br>
