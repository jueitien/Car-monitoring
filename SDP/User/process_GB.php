...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $store_appoinment="INSERT INTO `appointment`(`User ID`, `Name` , `Maintenance` , `Time`, `Day`, `Request status`, `Car Type`) VALUES ('$ID','$Username','GearBox','$time','$day','Pending','$Car_Type')";
